  ...
  const fetchProducts = useCallback(async (pageNum: number = 1) => {
    try {
      ...
      const response = await api.get<ProductResponse>(
        `/api/products?page=${pageNum}&limit=${limit}&category=transmission`
      );
      ...
      console.error('Failed to fetch transmission:', error);
    } finally {
      setLoading(false);
    }
  }, []);
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-4">Transmission</h1>
          <p className="text-gray-600">Browse our collection of high-quality transmission parts</p>
        </div>
